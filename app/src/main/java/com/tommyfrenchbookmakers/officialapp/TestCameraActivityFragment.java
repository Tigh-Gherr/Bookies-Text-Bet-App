 ...
 */
public class TestCameraActivityFragment extends Fragment implements ZBarScannerView.ResultHandler {
    ...
    public TestCameraActivityFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_test_camera, container, false);
