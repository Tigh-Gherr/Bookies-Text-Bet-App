        ...
        public BetterSelectionsViewHolder(View itemView) {
            ...
            mMore.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    popupMenu.getMenu().findItem(R.id.popup_takeOdds).setChecked(s.isTakingOdds());
                    popupMenu.getMenu().findItem(R.id.popup_nrFav).setChecked(s.isNonRunnerInsertFav());
                    popupMenu.getMenu().findItem(R.id.popup_nr2ndFav).setChecked(s.isNonRunnerInsertSecondFav());
                            ...
                            switch (item.getItemId()) {
                                ...
                                case R.id.popup_nrFav:
                                    ...
                                    if (item.isChecked()) {
                                        ...
                                        popupMenu.getMenu().findItem(R.id.popup_nr2ndFav).setChecked(false);
                                    }
                                    return true;
                                case R.id.popup_nr2ndFav:
                                    ...
                                    if(item.isChecked()) {
                                        ...
                                        popupMenu.getMenu().findItem(R.id.popup_nrFav).setChecked(false);
                                    }
                                    return true;
                                default:
                                    return false;
